...
# ── CSS API ingest settings ───────────────────────────────────────────────────────
CSS_API_URL: str = _settings.CSS_API_URL

# ── CVD API settings ──────────────────────────────────────────────────────
_cvd = _api.get("cvd", {})
CVD_AUTH_URL:    str = _settings.CVD_AUTH_URL
CVD_API_URL:     str = _settings.CVD_API_URL
CVD_BATCH_SIZE:  int = _cvd.get("batch_size", 50)
CVD_CALLING_APP: str = _cvd.get("calling_app")      # TODO
...
ROUND_HRS: int = _cfg["rounding"]["hrs_decimals"]
