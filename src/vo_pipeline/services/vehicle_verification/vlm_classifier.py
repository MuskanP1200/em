...
class AzureVLMImageClassifier:
    ...
    def _build_prompts(self):
        ...
        system_prompt = (
            ...
            "  - Must represent odometer/trip/speed/mileage information.\n"
            "  - If miles coved is readable, extract the miles.\n\n"
        ...
        user_instruction = (
            ...
            "  NOTE: Sometimes some letters in the License Plate are written vertically "
            "as compared to other letters. Read those letters as well carefully.\n"
