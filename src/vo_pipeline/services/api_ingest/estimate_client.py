...
def _empty_cdr_rates() -> dict:
    ...
    return {
        k: None
        for k in [
            "grp_nbr", "vndr_name", "grp_note_txt", "specl_instruct_txt",
            "xcld_frm_cdr_ind",
            "bdy_lbr_rate", "mchncl_lbr_rate", "frm_lbr_rate", "almn_lbr_rate",
            "pnt_mtrl_rate", "dmstc_part_disc_amt", "frn_part_disc_amt", "kyls_disc_amt",
            "cdr_included_amt_frm", "cdr_included_amt_to", "thrshld_amt",
            "anti_crsn_dsc", "car_cvr_dsc", "clr_snd_bf_dsc", "flx_add_dsc",
            "four_whl_algn_dsc", "frm_pull_tm_dsc", "frm_setup_dsc", "frnt_whl_algn_dsc",
            "hzrd_wst_dsc", "msk_jams_dsc", "mnt_bal_tir_dsc", "sm_slr_dsc", "adhsn_prm_dsc",
            "clbrtn", "prescn", "postscn",
