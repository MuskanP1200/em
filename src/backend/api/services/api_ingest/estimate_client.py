...
def get_cdr_group_vendor(token: str, vendor_id: str, group_number: str) -> dict:
    ...
    result = {
        ...
        # "shop_contact_name":        stxt("ShopContactName"),
        # "shop_contact_email":       stxt("ShopContactEmail"),
        # "vr_contact_emp_id":        stxt("VrContactEmpId"),
        # "vr_contact_name":          stxt("VrContactName"),
        # "version":                  stxt("Version"),
        "exclude_from_cdr_ind": sbool("ExcludeFromCDRIndicator"),
        # ── Labour rates ──────────────────────────────────────────────────────
        ...
        "cdr_incl_amt_from": flt("CDRIncludedAmountFrom"),
        "cdr_incl_amt_to": flt("CDRIncludedAmountTo"),
        "threshold": flt("Threshold"),
        # ── Additional charges / negotiated amounts ───────────────────────────
        # "partial_bumper_repairs":   flt("PartialBumperRepairs"),
        # "adhesion_promoter":        flt("AdhesionPromoter"),
        # "anti_corrosion":           flt("AntiCorrosion"),
        # "car_cover":                flt("CarCover"),
        # "color_sand_and_buff":      flt("ColorSandAndBuff"),
        # "flex_additive":            flt("FlexAdditive"),
        # "four_wheel_alignment":     flt("FourWheelAlignment"),
        # "frame_pull_time":          flt("FramePullTime"),
        # "frame_setup":              flt("FrameSetup"),
        # "front_wheel_alignment":    flt("FrontWheelAlignment"),
        # "hazardous_waste":          flt("HazardousWaste"),
        # "mask_jams":                flt("MaskJams"),
        # "mount_and_bal_tires":      flt("MountAndBalTires"),
        # "seam_sealer":              flt("SeamSealer"),
        "calibration": flt("Calibration"),
        "pre_scan": flt("PreScan"),
        "post_scan": flt("PostScan"),
        # ── Panel-level negotiated amounts ────────────────────────────────────
        # "bumper":                   flt("Bumper"),
        # "front_door":               flt("FrontDoor"),
        # "rear_door":                flt("RearDoor"),
        # "fender":                   flt("Fender"),
        # "hood":                     flt("Hood"),
        # "decklid":                  flt("Decklid"),
        # ── Other fees ────────────────────────────────────────────────────────
        # "basecoat_reduction":       flt("BasecoatReduction"),
        # "bumper_drop":              flt("BumperDrop"),
        # "paint_materials_cap":      flt("PaintMaterialsCap"),
        "estimate_fee": flt("EstimateFee"),
        # "shop_materials":           flt("ShopMaterials"),
        "sublet_markup": flt("SubletMarkup"),
        "tear_down_fee": flt("TearDownFee"),
        # "transport_fee":            flt("TransportFee"),
    }
