...
class LineItemOut(BaseModel):
    ...
    # grp_nbr: Optional[str] = None
    description: Optional[str] = None
    # Parts
    part_type: Optional[str] = None
    part_num: Optional[str] = None
    part_price: Optional[str] = None
    tot_part_price: Optional[str] = None
    part_qty: Optional[str] = None
    line_adj_amt: Optional[str] = None
    # Labor
    lbr_type: Optional[str] = None
    lbr_hrs: Optional[str] = None
    actual_lbr_rate: Optional[str] = None
    expected_lbr_rate: Optional[str] = None
    lbr_amt: Optional[str] = None
    lbr_amt: Optional[str] = None
    expected_lbr_amt: Optional[str] = None  # computed as hrs × expected_rate
    # Other charges
    other_chrg_desc: Optional[str] = None
    other_chrg_amt: Optional[str] = None
    # Status + finding
    part_ai_status: Optional[str] = None
    lbr_ai_status: Optional[str] = None
    other_chrg_ai_status: Optional[str] = None
    parts_finding: Optional[str] = None
    flag_special: bool = False

    @field_validator("part_ai_status", "lbr_ai_status")
    @classmethod
...
class BreakdownItemOut(BaseModel):
    ...
    negative: bool
    # Hours & rate fields
    hrs: Optional[str] = None  # paint — single value
    actual_hrs: Optional[str] = None  # labor — actual hours
    expected_hrs: Optional[str] = None  # labor — expected hours
    actual_rate: Optional[str] = None
...
class BreakdownSubsectionOut(BaseModel):
    label: str
    subtotal: str = "$0.00"
    subtotal_per_ai: Optional[str] = None
    subtotal_ai_status: str = "pending"
    adjustment: str = "$0.00"
    adjustment_per_ai: Optional[str] = None
    adjustment_ai_status: str = "pending"
    adjustment_label: str = ""
    adjustment_pct: Optional[str] = None

    @field_validator("subtotal_ai_status", "adjustment_ai_status")
    @classmethod
...
class BreakdownSectionOut(BaseModel):
    total: str
    total_per_ai: Optional[str] = None
    items: List[BreakdownItemOut] = []
    subsections: List[BreakdownSubsectionOut] = []
...
class BreakdownOut(BaseModel):
    ...
    materials_misc: BreakdownSectionOut = Field(default_factory=BreakdownSectionOut)
...
class TotalOut(BaseModel):
    amount: str
    amount_per_ai: Optional[str] = None
