...
Toggle between mock data and the real backend using USE_MOCK.

USE_MOCK = True  → returns full dummy data from this file (original behaviour)
USE_MOCK = False → proxies calls to the real backend API

Set via environment variable:
USE_MOCK_DATA=true  uvicorn main:app --reload   ← mock (default)
USE_MOCK_DATA=false uvicorn main:app --reload   ← real backend

Or flip the hardcoded default below directly.
"""
...
_DETAIL_25437: dict[str, Any] = {
    ...
    "photos": [
        ...
        },
        {
            ...
            "label": "Quarter Panel LT — Refinish",
            "badge": "refinish",
            "orientation": "portrait",
        },
        {
    ...
    "line_items": [
        {
            "line": "001",
            "op": "RI",
            "description": "Front bumper cover R&I",
            "type": None,
            "part_num": None,
            "price": None,
            "qty": None,
            ...
            "paint": None,
            "adjustment": None,
            "adjustment_per_ai": None,
            "adjustment_ai_status": None,
            "ai_status": "approved",
            "flag_special": False,
        },
        {
            "line": "002",
            "op": "RR",
            "description": "Grille, Frt Bmpr Cvr",
            "type": "N",
            "part_num": "622546LY0A",
            "price": "$612.49",
            "qty": "1",
            ...
            "paint": None,
            "adjustment": "-25%",
            "adjustment_per_ai": "-28%",
            "adjustment_ai_status": "flagged",
            "ai_status": "flagged",
            "flag_special": False,
        },
        {
        ...
        },
        {
            "line": "006",
            "op": "RR",
            "description": "Tape, Quarter Panel LT",
            "type": "N",
            "part_num": "788656LB0A",
            "price": "$26.53",
            "qty": "1",
            ...
            "paint": None,
            "adjustment": "-15%",
            "adjustment_per_ai": "-15%",
            "adjustment_ai_status": "approved",
            "ai_status": "approved",
            "flag_special": False,
        },
        {
        ...
        },
        {
            "line": "010 *",
            "op": "SUB",
            "description": "Cover car exterior",
            "type": None,
            "part_num": None,
            "price": "$5.00",
            "qty": None,
        ...
        },
        {
            "line": "011 *",
            "op": "SUB",
            "description": "Hazardous waste removal",
            "type": None,
            "part_num": None,
            "price": "$5.00",
            "qty": None,
        ...
        },
        {
            "line": "013 * †",
            "op": "SUB",
            "description": "Front radar calibration",
            "type": None,
            "part_num": None,
            "price": "$760.00",
            "qty": None,
            ...
            "subsections": [
                {
                    ...
                    "subtotal": "$26.53",
                    "subtotal_per_ai": "$26.53",
                    "subtotal_ai_status": "approved",
                    "adjustment": "-$3.98",
                    "adjustment_per_ai": "-$3.98",
                    "adjustment_ai_status": "approved",
                    "adjustment_label": "-15%",
                },
                {
                    "label": "Foreign Parts",
                    "subtotal": "$612.49",
                    "subtotal_per_ai": "$612.49",
                    "subtotal_ai_status": "approved",
                    "adjustment": "-$153.12",
                    "adjustment_per_ai": "-$171.50",
                    "adjustment_ai_status": "flagged",
                    "adjustment_label": "-25%",
                },
                {
                    ...
                    "subtotal": "$0.00",
                    "subtotal_per_ai": "$0.00",
                    "subtotal_ai_status": "approved",
                    "adjustment": "$0.00",
                    "adjustment_per_ai": "$0.00",
                    "adjustment_ai_status": "approved",
                    "adjustment_label": "-0%",
                },
            ],
...
def compute_progress_tabs(detail: Dict[str, Any]) -> List[Dict[str, str]]:
    ...
    return [
        ...
        {
            "label": "Line Item Price & Discount Check",
            "status": li_status,
            "target": "section-lineitems",
        },
        {
            "label": "Subtotals & Discount Check",
            "status": sub_status,
            "target": "section-breakdown",
        },
        {
            "label": "Total & Taxes Check",
            "status": total_status,
...
def _make_detail(
    ...
    _total_pai = (
        _adj_amount(total_amount, _DELTA)
        if _flag
        else (total_amount_per_ai or total_amount)
    )
    detail: Dict[str, Any] = {
        "topbar": {
            "incident_num": inc_id,
        ...
        "vehicle_info": {
            "fields": [
                ...
                [
                    ...
                    {
                        "label": "Hold Status Reason",
                        "value": hold_reason,
                        "muted": hold_reason == "N/A",
                    },
                    {
                        "label": "Rpr Hold Reason",
                        "value": rpr_hold_reason,
        ...
        "line_items": [
            ...
            },
            {
                "line": "003",
                "op": "RR",
                "description": "Headlamp assembly, LT",
                "type": "N",
                "part_num": "811500R020",
                "price": "$542.00",
                "qty": "1",
                "labor": "0.8 B",
                "paint": None,
                "adjustment": "-20%" if _flag else "-15%",
                "adjustment_per_ai": "-15%",
                "adjustment_ai_status": _chk(),
                "ai_status": _chk(),
                "flag_special": False,
            },
            {
        ...
        "breakdown": {
            "labor": {
                ...
                "items": [
                    {
                        "label": f"Body (2.8 hrs @ {body_rate.split('/')[0].strip()})",
                        "value": "$112.00",
                        "value_per_ai": "$112.00",
                        "ai_status": _ok(),
                        "negative": False,
                    ...
                    {
                        "label": f"Refinish (2.0 hrs @ {body_rate.split('/')[0].strip()})",
                        "value": "$80.00",
                        "value_per_ai": "$80.00",
                        "ai_status": _ok(),
                        "negative": False,
                ...
                "subsections": [
                    {
                        "label": "Domestic Parts",
                        "subtotal": "$289.95",
                        "subtotal_per_ai": "$289.95",
                        "subtotal_ai_status": _ok(),
                        "adjustment": "-$43.49",
                        "adjustment_per_ai": "-$43.49",
                        "adjustment_ai_status": _ok(),
                        "adjustment_label": "-15%",
                    },
                    {
                        "label": "Foreign Parts",
                        "subtotal": "$542.00",
                        "subtotal_per_ai": "$508.45" if _flag else "$542.00",
                        "subtotal_ai_status": _chk(),
                        "adjustment": "-$81.30",
                        "adjustment_per_ai": "-$76.27" if _flag else "-$81.30",
                        "adjustment_ai_status": _chk(),
                        "adjustment_label": "-15%",
                    },
                    {
                ...
                "items": [
                    {
                        "label": "New parts subtotal",
                        "value": "$831.95",
                        "value_per_ai": "$798.40" if _flag else "$831.95",
                        "ai_status": _chk(),
                        "negative": False,
                    },
                    {
...
INCIDENT_DETAILS: Dict[str, Any] = {
    ...
    "320054": _make_detail(
        "320054",
        "2023 Toyota Camry SE · Fleet Unit",
        "SILVER",
        "TX",
        "RTX9821",
        "4T1B11HK8NU123456",
        ...
        parts_viewer="N",
        purchase_date="N/A",
        in_service_date="11/12/22",
        branch_type="DAILY RENTAL",
        adjuster="F812KX – JONES, MA",
        hold_reason="N/A",
        rpr_hold_reason="N/A",
        rptd_by="f22k1p",
        rpt_gpbr="42TX",
    ...
    "035461": _make_detail(
        "035461",
        "2022 Honda Civic EX · GP08 — Susan Park",
        "BLUE",
        "CA",
        "7HQP234",
        "2HGFE2F59NH800123",
        ...
        use_code="DR",
        parts_viewer="Y",
        purchase_date="03/15/21",
        in_service_date="04/01/21",
        branch_type="CORPORATE",
        adjuster="A200LT – PARK, SU",
        hold_reason="Body Hold",
        rpr_hold_reason="N/A",
        rptd_by="a88q3r",
        rpt_gpbr="38CA",
        dol="02/03/2026",
        rpt_date="02/04/2026",
        plate_ai_status="flagged",
        plate_per_ai="7HQP234 · CO",
        body_rate="$41.00 / hr",
        mech_rate="$46.00 / hr",
        frame_rate="$41.00 / hr",
        paint_rate="$23.00 / hr",
    ...
    "61265181": _make_detail(
        "61265181",
        "2021 Ford F-150 XLT · GP12 — Marcus Hill",
        "WHITE",
        "FL",
        "FLA4432",
        "1FTEW1EP5MFB11234",
        ...
        parts_viewer="N",
        purchase_date="N/A",
        in_service_date="06/22/20",
        branch_type="DAILY RENTAL",
        adjuster="T904JB – HILL, MA",
        hold_reason="N/A",
        rpr_hold_reason="N/A",
        rptd_by="t99j4b",
        rpt_gpbr="45FL",
    ...
    "1055188": _make_detail(
        "1055188",
        "2020 Chevrolet Malibu LT · GP05 — Dana Cole",
        "BLACK",
        "OH",
        "OHJ9921",
        "1G1ZD5ST7LF088765",
        ...
        use_code="EX",
        parts_viewer="N",
        purchase_date="08/10/19",
        in_service_date="09/01/19",
        branch_type="CORPORATE",
        adjuster="P301QZ – COLE, DA",
        hold_reason="N/A",
        rpr_hold_reason="Parts Hold",
        rptd_by="p30q1z",
        rpt_gpbr="33OH",
        dol="01/28/2026",
        rpt_date="01/29/2026",
    ...
    "698412": _make_detail(
        "698412",
        "2024 Nissan Altima SR · GP02 — Kevin Walsh",
        "RED",
        "NV",
        "NV88014",
        "1N4BL4BV5RN123987",
        ...
        parts_viewer="N",
        purchase_date="N/A",
        in_service_date="02/28/24",
        branch_type="DAILY RENTAL",
        adjuster="K741RS – WALSH, KE",
        hold_reason="N/A",
        rpr_hold_reason="N/A",
        rptd_by="k74r1s",
        rpt_gpbr="50NV",
    ...
    "9846503": _make_detail(
        "9846503",
        "2022 Dodge Ram 1500 · GP15 — Larry Tran",
        "GRAY",
        "AZ",
        "AZR3310",
        "1C6SRFFT6NN123400",
        ...
        parts_viewer="Y",
        purchase_date="N/A",
        in_service_date="08/15/21",
        branch_type="FLEET",
        adjuster="G502TV – TRAN, LA",
        hold_reason="N/A",
        rpr_hold_reason="N/A",
        rptd_by="g50t2v",
        rpt_gpbr="47AZ",
    ...
    "4421098": _make_detail(
        "4421098",
        "2023 Hyundai Sonata N · GP07 — Rachel Kim",
        "ORANGE",
        "WA",
        "WAB2290",
        "KMHL14JA8PA123321",
        ...
        use_code="DR",
        parts_viewer="N",
        purchase_date="01/05/23",
        in_service_date="01/20/23",
        branch_type="DAILY RENTAL",
        adjuster="M110PX – KIM, RA",
        hold_reason="N/A",
        rpr_hold_reason="N/A",
        rptd_by="m11p0x",
        rpt_gpbr="36WA",
        dol="03/05/2026",
        rpt_date="03/06/2026",
        vin_ai_status="flagged",
        vin_per_ai="KMHL14JA8NA123321",
        body_rate="$40.00 / hr",
        mech_rate="$45.00 / hr",
        frame_rate="$43.00 / hr",
        paint_rate="$22.00 / hr",
    ...
    "7730021": _make_detail(
        "7730021",
        "2024 Kia Sportage EX · GP03 — Ben Ortiz",
        "GREEN",
        "CO",
        "COX8871",
        "5XYP3DHCXRG123789",
        ...
        parts_viewer="N",
        purchase_date="N/A",
        in_service_date="11/30/23",
        branch_type="DAILY RENTAL",
        adjuster="J400WV – ORTIZ, BE",
        hold_reason="N/A",
        rpr_hold_reason="N/A",
        rptd_by="j40w0v",
        rpt_gpbr="52CO",
    ...
    "5519872": _make_detail(
        "5519872",
        "2022 BMW 330i xDrive · GP11 — Claire Evans",
        "WHITE",
        "NY",
        "NYC5593",
        "WBA5R7C01NFS12345",
        ...
        use_code="DR",
        parts_viewer="Y",
        purchase_date="04/18/22",
        in_service_date="05/01/22",
        branch_type="CORPORATE",
        adjuster="L880TK – EVANS, CL",
        hold_reason="N/A",
        rpr_hold_reason="N/A",
        rptd_by="l88t0k",
        rpt_gpbr="29NY",
    ...
    "8834410": _make_detail(
        "8834410",
        "2021 Subaru Outback Premium · GP09 — Tom Reyes",
        "BROWN",
        "OR",
        "ORG6640",
        "4S4BTADC4M3103456",
        ...
        parts_viewer="N",
        purchase_date="N/A",
        in_service_date="07/14/20",
        branch_type="FLEET",
        adjuster="B225NF – REYES, TO",
        hold_reason="Collision",
        rpr_hold_reason="Frame Hold",
        rptd_by="b22n5f",
        rpt_gpbr="31OR",
        dol="01/05/2026",
        rpt_date="01/06/2026",
        vin_ai_status="flagged",
        vin_per_ai="4S4BTADC4N3103456",
        body_rate="$44.00 / hr",
        mech_rate="$50.00 / hr",
        frame_rate="$46.00 / hr",
        paint_rate="$24.00 / hr",
    ...
    "2267543": _make_detail(
        "2267543",
        "2023 Jeep Wrangler Sport · GP14 — Amy Chen",
        "YELLOW",
        "UT",
        "UTW1102",
        "1C4HJXDN8PW123654",
        ...
        parts_viewer="N",
        purchase_date="N/A",
        in_service_date="03/22/23",
        branch_type="DAILY RENTAL",
        adjuster="H675RP – CHEN, AM",
        hold_reason="N/A",
        rpr_hold_reason="N/A",
        rptd_by="h67r5p",
        rpt_gpbr="55UT",
    ...
    "9912004": _make_detail(
        "9912004",
        "2024 Tesla Model 3 LR · GP06 — Jake Moore",
        "RED",
        "CA",
        "TES8820",
        "5YJ3E1EA1RF123321",
        ...
        use_code="EV",
        parts_viewer="Y",
        purchase_date="11/02/23",
        in_service_date="11/15/23",
        branch_type="CORPORATE",
        adjuster="C440EV – MOORE, JA",
        hold_reason="N/A",
        rpr_hold_reason="N/A",
        rptd_by="c44e0v",
        rpt_gpbr="39CA",
    ...
    "3345671": _make_detail(
        "3345671",
        "2022 Mazda CX-5 Touring · GP04 — Nina Patel",
        "BLUE",
        "GA",
        "GAM4410",
        "JM3KFBCM6N0123987",
        ...
        use_code="DR",
        parts_viewer="N",
        purchase_date="06/27/21",
        in_service_date="07/15/21",
        branch_type="DAILY RENTAL",
        adjuster="D770MZ – PATEL, NI",
        hold_reason="N/A",
        rpr_hold_reason="N/A",
        rptd_by="d77m0z",
        rpt_gpbr="44GA",
...
def _filter_incidents_mock(
    ...
    if search:
        s = search.lower()
        results = [
            i for i in results if s in i["id"].lower() or s in i["sub_text"].lower()
        ]
    return results
...
def _get_incident_detail_mock(incident_id: str) -> Optional[Dict[str, Any]]:
...
# ════════════════════════════════════════════════════════════════
# REAL BACKEND  (proxies to the new FastAPI backend)
#
# Images in real mode:
#   - The backend returns SAS URLs in photo.url / photo.lightbox_url
#   - image_data is always None (frontend fetches from Azure directly)
#   - No special handling needed here — the backend response is passed
#     straight through to the frontend unchanged
# ════════════════════════════════════════════════════════════════
