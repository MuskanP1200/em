...
class Settings(BaseSettings):
    ...
    VO_AZURE_CLIENT_ID: str = "0aa49363-e5cf-41b3-89ef-544160e92de7"
    VO_AZURE_CLIENT_SECRET: str = ""
    VO_AZURE_TENANT_ID: str = "f758521c-55a3-4def-80ff-1cf2e611191a"
    AUTHORITY: str = f"https://login.microsoftonline.com/{VO_AZURE_TENANT_ID}"
    REDIRECT_PATH: str = "/oauth2callback"
    REDIRECT_URI: str = "https://ui.veh-repair-assistant.ehiazure-sandbox.com"
    SCOPES: list[str] = [""]
    SESSION_SECRET: str = ""
