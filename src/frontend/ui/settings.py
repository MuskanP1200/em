...
VAULT_FIELDS = {"SESSION_SECRET", "VO_AZURE_CLIENT_SECRET", "REDIS_ACCESS_KEY"}
...
class Settings(BaseSettings):
    ...
    REDIS_HOST: str = "vodev.redis.cache.windows.net"
    REDIS_ACCESS_KEY: str

    @property
    def scopes(self) -> list[str]:
        return [f"{self.VO_AZURE_CLIENT_ID}/.default"]
